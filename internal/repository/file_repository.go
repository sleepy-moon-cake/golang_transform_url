...
func (r *FileRepository) GetStats(ctx context.Context) (model.URLStats, error) {
	return model.URLStats{}, errors.New("not support for filestorage, pls use datastorage")
}
